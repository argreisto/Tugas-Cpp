...
int main()
{
    cout << "=== (B) PROGRAM MENAMPILKAN DATA DENGAN NILAI = 90 PADA LINEAR DOUBLE LINKED LIST ===\n" << endl;
    for (int i = 0; i < 100; i++) cout << "=";
    cout << endl;

    cout << "Catatan :" << endl;
    cout << " - Program ini otomatis menambahkan satu data awal (Budi - 2007140022 - 90)." << endl;
    ...
    cout << " - Program akan menampilkan semua data dengan NILAI = 90." << endl;
...
int main() {
   ...
   // Tampilkan data dengan NILAI = 90
}
)" << endl;
    ...
    //=== Tampilkan hasil akhir (data dengan nilai = 90)
    for (int i = 0; i < 100; i++) cout << "=";
    cout << endl;
	cout << "--- DATA DENGAN NILAI = 90 ---\n" << endl;
